...
import {
  LayoutDashboard, List, Users, Activity,
  MessageSquare, Brain, Plus, ChevronDown
} from "lucide-react";
      ...
      <div className="p-3 border-b border-kafka-border">
        ...
        >
          <span className="font-medium truncate">
            {activeCluster?.name || "Sélectionner un cluster"}
          </span>
      ...
      <nav className="flex-1 p-3 space-y-1">
        {NAV.map(({ to, icon: Icon, label, badge }) => (
          ...
          >
            ...
            {badge && (
              <span className="text-xs px-1.5 py-0.5 bg-kafka-accent rounded text-white font-medium">
                {badge}
              </span>
            )}
          </NavLink>
